...
def function2():
    ...
    x = np.arange(10,36,dtype=np.float64).reshape((3,3,3))     #wrtie your code here
...
def function3():
    ...
    x = a[np.where((a % 5 == 0) & (a % 7 == 0))]  #wrtie your code here
    return x
    """
    Expected Output:
...
def function13():
    ...
    ans = arr[np.where((arr >= 6) & (arr <= 9))] #write your code here 
    return ans
...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans = np.column_stack((x,y)) #write your code here
...
def function18():
    ...
    x = np.size(np.intersect1d(piaic,students)) # Write you code Here
    return x
...
def function19():
    ...
    output = np.dot(X ,W) + 5 # Write your code here
